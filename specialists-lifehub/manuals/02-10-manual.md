...
> Deel van de Claude Specialists — het draagbare vakboek (plugin `specialists-lifehub`). De repo-specifieke aanvulling leest de specialist uit `.claude/extensions/02-10.md` van de consumerende repo. Toegewezen door Chris, de Chief of Staff.
...
> `.claude/extensions/02-10.md` van de consumerende repo.*
